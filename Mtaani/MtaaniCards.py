...
# ---------------------------------------------
class MtaaniCardBox():
    " The base class for all Mtaani card boxes"
...
class MtaaniMathreeBox(MtaaniCardBox):
    " The base class for all Mtaani mathree boxes; extends MtaaniCardBox "
    def __init__(self, gameContext, fontSizes):
        MtaaniCardBox.__init__(self, 'Mathree Cards', gameContext, fontSizes) # ancestral constructor
...
class MtaaniGanjiBox(MtaaniCardBox):
    " The base class for all Mtaani finance boxes; extends MtaaniCardBox "
    def __init__(self, gameContext, fontSizes):
        MtaaniCardBox.__init__(self, 'Ganji Cards', gameContext, fontSizes) # ancestral constructor
