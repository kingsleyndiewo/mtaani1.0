...
# File name: MtaaniNonMorgTile.py
...
# ---------------------------------------------
class MtaaniNonMorgTile(MtaaniTile):
    " The base class for all Mtaani non-mortgageable tiles; extends MtaaniTile "
    ...
    def playerArrives(self, player, boardObj, playerCount):
        # call parent method
        super(MtaaniNonMorgTile, self).playerArrives(player, boardObj, playerCount)
    ...
    def tileCallback(self, instance):
        ...
        super(MtaaniNonMorgTile, self).tileCallback(instance)
