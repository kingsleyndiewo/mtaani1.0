...
# ---------------------------------------------
# a class that defines the Ganji interactivity suite
class GanjiInteraction:
    " The base class for all Ganji interactions "
